###############################################################################
## Script for testing how Lepidoptera insect species vary in space
###############################################################################
...
my_group_for_analysis <- "lepidoptera"
insects_dt <- mueller_all[group_for_analysis == my_group_for_analysis]
...
# [83] "Gymnadenia conopsea (L.) R. Br."                                     
# [84] "Gymnadenia conopsea (L.) R.Br."
# 
# [173] "Sempervivum tectorum L. s.l."                                        
# [174] "Sempervivum tectorum L. s.L."

insects_dt[plant_sp == "Gymnadenia conopsea (L.) R. Br.", 
           plant_sp := "Gymnadenia conopsea (L.) R.Br."]

insects_dt[plant_sp == "Sempervivum tectorum L. s.L.", 
           plant_sp := "Sempervivum tectorum L. s.l."]
...
write.csv(insects_dt, 
          file = paste0("output/", my_group_for_analysis, "/", my_group_for_analysis,
...
# Check and remove any error in location names
sort(unique(insects_dt$loc_5), na.last = TRUE)
insects_dt <- insects_dt[loc_5 != "X_exclude!"]
...
sites_2split <- c("Stelvio, Piz Umbrail, Spondalonga")
