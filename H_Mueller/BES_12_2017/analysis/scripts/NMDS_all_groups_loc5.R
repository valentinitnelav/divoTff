###############################################################################
## Script for testing how selected groups of insect species vary in space
###############################################################################
...
# remove the "?" plant records
insects_dt <- insects_dt[plant_sp != "?"] 
...
insects_dt[plant_sp == "Phyteuma scheuchzeri", 
           plant_sp := "Phyteuma scheuchzeri All."]
